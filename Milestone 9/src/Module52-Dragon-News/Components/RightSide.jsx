...
function RightSide() {
    let { googleLogin, userImage } = useContext(AuthContext);
    ...
    return(
        <div className="space-y-5">
            {/* login with  */}
            {
                !userImage ? <div className="grid grid-cols-1 gap-2">
                    <h1 className="text-[20px] font-semibold">Login With</h1>
                    {/* Google */}
            ...
            <div className="grid grid-cols-1 gap-2 ">
                <h1 className="text-[20px] font-semibold">Find Us On</h1>
                <a className = "w-full" href="https://www.facebook.com/DailyStarNews/" target="_blank">
                ...
                <a className="w-full" href="https://x.com/dailystarnews" target="_blank">
                ...
                <a className="w-full" href="https://www.linkedin.com/company/thedailystar/?originalSubdomain=bd" target="_blank">
            ...
            <div className="bg-base-200 p-5 rounded-xl space-y-3">
                <h1 className="text-[20px] font-semibold">Q-Zone</h1>
                <img src={ qzone1 } />
                <img src={ qzone2 } />
                <img src={ qzone3 } />
            </div>
